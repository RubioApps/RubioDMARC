...
class Pagination
{
    ...
    {   
        ...
        $chromePath = OD_THEMES . DIRECTORY_SEPARATOR . $this->config->theme . DIRECTORY_SEPARATOR . 'pagination.php';
    ...
    protected function _item_active(PaginationObject $item)
    {
        ...
        return '<a href="' . $item->link . '" class="btn-primary"><span>' . $item->text . '</span></a>';
    }
    ...
    protected function _item_inactive(PaginationObject $item)
    {
        ...
        return '<a href="' . $item->link . '"><span>' . $item->text . '</span></a>';
    }
