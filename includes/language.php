...
class Language
{
     ...
     *
     */
    public function getKnownLanguages($basePath = OD_SITE)
    {
    ...
    public function getLanguages($key = 'default')
    {
        ...
        if (empty($this->languages)) {
            $languages[$key] = [];
            $knownLangs = $this->getKnownLanguages(OD_SITE);
     ...
     */
    public function getLanguagePath($basePath = OD_SITE, $language = null)
    {
    ...
    public function getMetadata($lang)
    {
        ...
        $file = $this->getLanguagePath(OD_SITE, $lang) . '/langmetadata.xml';

        if (!is_file($file)) {
            $file = $this->getLanguagePath(OD_SITE, $lang) . '/' . $lang . '.xml';
        }
     ...
     *
     */
    public function load($basePath = OD_SITE, $lang = null, $reload = false, $default = true)
    {
